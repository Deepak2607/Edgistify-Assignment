            ...
            return(  
                    <div key={post._id} className="post bg-white p-1 my-1">
                      ...
                      <div>
                        ...
                        <p className="post-date"> Posted on <Moment format='MMMM Do YYYY, h:mm:ss a'>{post.date}</Moment> </p>
                        ...
                        {( post.user && post.user === props.user._id) && (   
                            <button onClick={()=> props.deletePost(post._id)} type="button" className="btn btn-danger">Delete Post
                            </button>
                         )}     
                      </div>
                    </div>
